...
if ($pension != '' && $_SESSION['Role'] === $pension['Ville']){
    header("Location: account_pen.php");
    exit;
}
        ...
        <section id="features" class="features">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Compte <?php if ($pension != '') { echo $_SESSION['Role'];
                        } else if ($_SESSION['Role'] === 'ADMIN') { echo $_SESSION['Role']; } ?></h2>
                    ...
                    <div class="col-lg-3">
                        <ul class="nav nav-tabs flex-column">
                            ...
                            <?php if ($_SESSION['Role'] === 'ADMIN') { ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/create/prix.php">Crée un Tarif</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <?php } if ($pension != '' && $_SESSION['Role'] === $pension['Ville']) { ?>
                                    <li class="nav-item">
                                            ...
                                            <form method="post" action="app/update/animal.php">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="Espece">
                                                        Espece</label>
                                                    <select class="form-select chosen-select" id="Espece" name="Espece" disabled="disabled">
